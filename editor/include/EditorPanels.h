...
public:
    ...
    enum class Panel {
        ...
        CollisionAnalyzer,
        NavigationQuery,
        AiPerceptionDebugger,
        AutomatedTest,
        LocalizationEditor,
        AssetReferenceRepair,
        SourceControl,
        ProjectMigration,
        BuildSizeAnalyzer,
        UiLocalizationPreview,
        PluginManager,
        VisualScriptEditor,
        TextureViewer,
        Count
...
private:
    ...
    static constexpr std::array<bool, kPanelCount> kDefaultOpen{{
        true, true, false, false, true, true, false, false, false, false, false, false, true, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false
    }};
