...
public:
    ...
    // Dynamic irradiance volume state: green active, grey sleeping, red invalid,
    // amber relocated. Relocation offsets are shown as cyan vectors.
    void DrawDynamicIrradianceProbes(const engine::DynamicIrradianceSystem& system,
                                    const glm::vec3& cameraPosition,
                                    const glm::mat4& viewProj) const;

    // World-space diagnostic tiles generated by the Lighting Analysis panel.
    // Mode: 1 complexity, 2 shadows, 3 exposure, 4 unlit, 5 transparency.
    void DrawLightingAnalysisOverlay(
...
private:
    ...
    mutable std::unique_ptr<EditorLineRenderer> m_dynamicGiLines;
};
